...
const SignIn = () => {
  ...
  const handleSubmit = (event, setContext) => {
    ...
    fetch("https://caffelytics.com/users/sign-in", requestOptions)
      .then(res => res.json())
      .then(
        (result) => {
        ...
        (error) => {
          alert("Emails must be unique and passwords must be 12 or more characters")
        }
      )
            ...
            <div className="column is-two-fifths">
              <form className="box is-centered" onSubmit={(event) => {
                ...
                <div className="buttons ">
                  ...
                  } className="button block">Sign up</button>
                </div>
              </form>
            </div>
            <div className="column">
